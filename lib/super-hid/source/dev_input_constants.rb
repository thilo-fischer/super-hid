...
# This file defines constants used in the input_event struct as defined
# by the include/linux/input.h. This file is based on
# include/linux/input.h, Copyright (c) 1999-2002 Vojtech Pavlik,
...
module SuperHid::Source
  class DevInput
    ...
    module Constants
      ...
      EVENT_TYPES = {}
      constants.each do |c|
        EVENT_TYPES[eval(c.to_s)] = c if c =~ /^EV_/
      end
